...
namespace FS.TimeTracking.Report.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ActivityReportGridDto")]
    public partial class ActivityReportGridDto : IEquatable<ActivityReportGridDto>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ActivityReportGridDto" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ActivityReportGridDto() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ActivityReportGridDto" /> class.
        /// </summary>
        ...
        public ActivityReportGridDto(Guid id = default(Guid), DateTime startDate = default(DateTime), DateTime? endDate = default(DateTime?), string duration = default(string), string comment = default(string), string issue = default(string), string customerTitle = default(string), string projectTitle = default(string), string activityTitle = default(string), string orderTitle = default(string), string orderNumber = default(string), bool billable = default(bool), string customerCompanyName = default(string), string customerDepartment = default(string), string customerContactName = default(string), string groupBy = default(string))
        {
            this.Id = id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ActivityReportGridDto {\n");
        ...
        {
            return this.Equals(input as ActivityReportGridDto);
        }

        /// <summary>
        /// Returns true if ActivityReportGridDto instances are equal
        /// </summary>
        /// <param name="input">Instance of ActivityReportGridDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ActivityReportGridDto input)
        {
            if (input == null)
            {
                return false;
