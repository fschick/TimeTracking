...
internal class DateTimeOffsetInterceptor : IPropertyFilterInterceptor
{
    public Expression<Func<TEntity, bool>> CreatePropertyFilter<TEntity>(PropertyInfo propertyInfo, ValueFilter[] filters, FilterConfiguration configuration)
    {
        if (typeof(TEntity) == typeof(TimeSheet) && propertyInfo.Name == nameof(TimeSheet.StartDate))
            return (Expression<Func<TEntity, bool>>)(object)PropertyFilterExpressionCreator.CreateFilter((TimeSheet x) => x.StartDateLocal, filters, configuration);

        if (typeof(TEntity) == typeof(TimeSheet) && propertyInfo.Name == nameof(TimeSheet.EndDate))
            return (Expression<Func<TEntity, bool>>)(object)PropertyFilterExpressionCreator.CreateFilter((TimeSheet x) => x.EndDateLocal, filters, configuration);

        if (typeof(TEntity) == typeof(Order) && propertyInfo.Name == nameof(Order.StartDate))
            return (Expression<Func<TEntity, bool>>)(object)PropertyFilterExpressionCreator.CreateFilter((Order x) => x.StartDateLocal, filters, configuration);

        if (typeof(TEntity) == typeof(Order) && propertyInfo.Name == nameof(Order.DueDate))
            return (Expression<Func<TEntity, bool>>)(object)PropertyFilterExpressionCreator.CreateFilter((Order x) => x.DueDateLocal, filters, configuration);

        if (typeof(TEntity) == typeof(Holiday) && propertyInfo.Name == nameof(Holiday.StartDate))
            return (Expression<Func<TEntity, bool>>)(object)PropertyFilterExpressionCreator.CreateFilter((Holiday x) => x.StartDateLocal, filters, configuration);

        if (typeof(TEntity) == typeof(Holiday) && propertyInfo.Name == nameof(Holiday.EndDate))
            return (Expression<Func<TEntity, bool>>)(object)PropertyFilterExpressionCreator.CreateFilter((Holiday x) => x.EndDateLocal, filters, configuration);
