...
public class CustomerChartService : ICustomerChartService
{
    ...
    /// <autogeneratedoc />
    public CustomerChartService(IOrderChartService orderChartService, ISettingService settingService, IFilterFactory filterFactory, IDbRepository dbRepository)
    {
