...
public class TimeSheetService : CrudModelService<TimeSheet, TimeSheetDto, TimeSheetGridDto>, ITimeSheetApiService
{
    ...
    /// <autogeneratedoc />
    public TimeSheetService(IDbRepository dbRepository, IMapper mapper, IFilterFactory filterFactory, IWorkdayService workdayService, IUserService userService, ISettingApiService settingService, AuthorizationService authorizationService)
