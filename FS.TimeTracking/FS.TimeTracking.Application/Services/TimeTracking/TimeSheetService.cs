...
public class TimeSheetService : CrudModelService<TimeSheet, TimeSheetDto, TimeSheetGridDto>, ITimeSheetService
{
    ...
    /// <autogeneratedoc />
    public TimeSheetService(IDbRepository dbRepository, IMapper mapper, IFilterFactory filterFactory, IWorkdayService workdayService, ISettingService settingService)
