...
internal class PermissionNames
{
    ...
    /// All role names.
    /// </summary>
    public static IEnumerable<string> All { get; } = GetAllRoleNames();

    /// <summary>
    /// Permissions used to build policies for generic CRUD model services.
    /// </summary>
    /// <autogeneratedoc />
    public static string[] CrudServicePolicyPermissions { get; } = {
    ...
    private static IEnumerable<string> GetAllRoleNames()
        => typeof(RoleNames)
            .GetFields()
            .Where(x => x.IsLiteral)
