...
export class TimesheetFilterComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  public ngAfterViewInit(): void {
    this.filterTemplates = {
      ...
      orderIsReadonly: this.filterNotImplemented,
      ...
      holidayIsReadonly: this.filterNotImplemented,
      ...
      userIsReadonly: this.filterNotImplemented,
    };
  ...
  private getEmptyFilter(): Record<FilterName, undefined> {
    return {
      ...
      timeSheetIsReadonly: undefined,
      projectId: undefined,
      projectTitle: undefined,
      projectComment: undefined,
      projectHidden: undefined,
      projectIsReadonly: undefined,
